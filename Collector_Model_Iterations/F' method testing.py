# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 00:25:59 2020
...
Ib = 200 #Input beam radiation incident on a flat surface in Watts per metre squared
Id = 200 #Input diffuse radiation incident on a flat surface in Watts per metre squared
...
#Ul = 2 #Input average total loss coefficient in Watts per metres squared kelvin
...
def absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array):
    ...
    Function_outputs = [Qu,Tfo,eff,T_diff,Ul,T_grad,Tfm,Tpm,F_dash]
    
    return Function_outputs

#Output an array of useful power results
Qu_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[0]
    
#Output an array of collector efficiency results
eff_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[2]

#Output an array of the results for the temperature difference between the mean fluid temperature and ambient temperature
T_diff_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[3]

#Output array for Ul results
Ul_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[4]

#Output array of plate to fluid temperature difference results
T_grad_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[5]

#Output array of fluid mean temperature
Tfm_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[6]

#Output array of plate mean temperature
Tpm_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[7]

#Output array of Fr
F_dash_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array)[8]
...
for i in range(len(eff_array)):
    ...
    wcell4 = ws.cell(i+2,5)
    wcell5 = ws.cell(i+2,6)
    wcell6 = ws.cell(i+2,7)
    #wcell7 = ws.cell(i+2,47)
    ...
    wcell6.value = Qu_array[i]
    #wcell7.value = F_dash_array[i]
