# -*- coding: utf-8 -*-
"""
Created on Wed Apr 15 11:21:43 2020
...
for u in range(len(beta_deg_list)):
    beta = beta_array[u]
    #print(beta)
    Tfi = 90
    #Create list to put incident hourly radiation in
...
for i in range(len(Qu_beta_list)):
    ...
    wcell1 = ws.cell(i+3,20)
    wcell2 = ws.cell(i+3,21)
    wcell3 = ws.cell(i+3,22)
    #wcell4 = ws.cell(i+3,48)
    #wcell5 = ws.cell(i+2,53)

    #State what value should be written to the cell
    wcell1.value = beta_deg_list[i]
