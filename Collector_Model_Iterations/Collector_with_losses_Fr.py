...
Li = 10 #Input inlet pipe length in metres
Lo = 10 #Input outlet pipe length in metres
...
for v in range(8760):
    ...
    def absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud_array,Li,Lo,Di,Do):
    ...
    Qu_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud_array,Li,Lo,Di,Do)[0]
    ...
    It_col_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud_array,Li,Lo,Di,Do)[1]
...
for i in range(len(Qu_tot)):
    ...
    wcell1 = ws.cell(i+3,58)
    wcell2 = ws.cell(i+3,57)
    wcell3 = ws.cell(i+3,56)
