# -*- coding: utf-8 -*-
"""
Created on Wed Mar 11 14:34:49 2020
...
def absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array):
...
Qu_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[0]
    
#Output an array of collector efficiency results
eff_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[2]

#Output an array of the results for the temperature difference between the mean fluid temperature and ambient temperature
T_diff_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[3]

#Output array for Ul results
Ul_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[4]

#Output array of plate to fluid temperature difference results
T_grad_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[5]

#Output array of fluid mean temperature
Tfm_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[6]

#Output array of plate mean temperature
Tpm_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[7]

#Output array of Fr
F_dash_array = absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,Fr,P,Tfi_array)[8]
...
for i in range(len(eff_array)):
    ...
    wcell1 = ws.cell(i+2,33)
    wcell2 = ws.cell(i+2,34)
    wcell3 = ws.cell(i+2,35)
    wcell4 = ws.cell(i+2,36)
    wcell5 = ws.cell(i+2,37)
    wcell6 = ws.cell(i+2,38)
    wcell7 = ws.cell(i+2,39)
