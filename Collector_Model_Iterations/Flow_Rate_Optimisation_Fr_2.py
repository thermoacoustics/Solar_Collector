...
for u in range(len(m_dot_list)):
    ...
    for v in range(8760):
        ...
        def absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb):
        ...
        Qu_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb)[0]
        ...
        Tfm_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb)[3]
        ...
        It_col_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb)[1]
        ...
        Tfo_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb)[2]
...
for i in range(len(Qu_beta_list)):
    ...
    wcell1 = ws.cell(i+3,42)
    wcell2 = ws.cell(i+3,43)
    wcell3 = ws.cell(i+3,44)
    wcell4 = ws.cell(i+3,45)
    wcell5 = ws.cell(i+2,46)
