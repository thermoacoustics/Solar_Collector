# -*- coding: utf-8 -*-
"""
Created on Fri Mar 20 11:57:38 2020
...
Uh = 238 #Input the house heat loss coefficient
...
for v in range(8760):
    ...
    def absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar,Ud,Li,Lo,Di,Do,Uh):
    ...
    Qu_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar,Ud,Li,Lo,Di,Do,Uh)[0]
    ...
    It_col_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar,Ud,Li,Lo,Di,Do,Uh)[1]
    ...
    Q_cool_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar,Ud,Li,Lo,Di,Do,Uh)[2]
...
for i in range(len(Q_cool_list)):
