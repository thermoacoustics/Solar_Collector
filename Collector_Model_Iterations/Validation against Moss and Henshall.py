# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 11:46:04 2020
...
def absorbed_radiation(Ib,Id,Pg,beta,theta_deg,t,a,Ac,Ta,m_dot,F_dash,P,Tfi_array):
    ...
    Ul = (49/4600)*(Tfi_array-Ta)+(343/460)
    ...
    Function_outputs = [Qu,Tfo,eff,T_diff,Ul]
...
wb = Workbook()
#wb = load_workbook("Incidence_angle_modifier_for_TVP_panel.xlsx")
