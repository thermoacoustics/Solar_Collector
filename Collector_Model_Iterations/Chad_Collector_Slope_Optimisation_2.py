# -*- coding: utf-8 -*-
"""
Created on Thu Mar 19 14:26:59 2020
...
for u in range(len(beta_deg_list)):
    ...
    for v in range(8760):
        ...
        def absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar):
        ...
        Qu_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar)[0]
        ...
        It_col_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,F_dash,P,Tfi,Ula,Ulb,Tfm_tar)[1]
...
for i in range(len(Qu_beta_list)):
    ...
    wcell1 = ws.cell(i+3,6)
    wcell2 = ws.cell(i+3,7)
    wcell3 = ws.cell(i+3,8)
