...
for v in range(8760):
    ...
    def absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud,Li,Lo,Di,Do):
    ...
    Qu_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud,Li,Lo,Di,Do)[0]
    ...
    It_col_array = absorbed_radiation(I,Ibh,Pg,beta,lat,n,h,t,a,Ac,Ag,Ta,m_dot,Fr,P,Tfi,Ula,Ulb,Ud,Li,Lo,Di,Do)[1]
...
for i in range(len(Qu_tot_list)):
    ...
    wcell2 = ws.cell(i+3,19)
    wcell3 = ws.cell(i+3,18)
